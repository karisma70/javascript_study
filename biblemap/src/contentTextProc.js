...
function getHistoryAdminStringObj( number ) {
    ...
    그 이후 예루살렘성을 정복하였으며 다윗 궁을 건축하기에 이른다" },
        ...
        { title : "BC 7C 앗수르 제국",
            ...
            여호와께서 앗수르 왕의 군대 장관들로 와서 치게 하시며 저희가 므낫세를 사로잡고 쇠사슬로 결박하여 바벨론으로 끌어간지라 <br><br>\
        < 이사야 10:5 - 7 > <br> \
    ...
    이 사건으로 사마리아인들은 유대인들로 부터 배척을 당하게 되는 계기가 되는데, 앗수르는 여러 민족을 이주시켜 사마리아 사람들과 이방인들과 결혼하도록 하였기 때문이다<br>\
    결국 북이스라엘 10지파는 멸망하게 되고, 앗수르왕 산헤립은 히스기야 왕이 다스리는 남유다 정복을 위해 애를 쓰지만(열하 18:13)  <br>\
