...
var mobileBibleMapPointLayers = [
    { url: 'history/History_12Sect_poi',  order: 18, style: {
    ...
    { url: 'level_11_poi',  order: 19, style: {
    ...
    { url: 'level_10_poi',  order: 20, style: {
    ...
    { url : 'level_9_poi',  order: 21, style: {
    ...
    { url : 'level_7_poi',  order: 22, style: {
        visibleRange : { max : 25 , min : 7.7 },
    ...
    { url: 'level_6_poi',  order: 24, style: {
        visibleRange : { max : 25 , min : 6.5 },
